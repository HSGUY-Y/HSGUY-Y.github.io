!function(e, t) {
  'object' == typeof exports&& 'object' == typeof module ?
      module.exports = t() :
      'function' == typeof define && define.amd ? define('APlayer', [], t) :
      'object' == typeof exports                ? exports.APlayer = t() :
                                                  e.APlayer = t()
}(window,
  function() {
    return function(e) {
      ...
      return n.m = e, n.c = t, n.d = function(e, t, i) {
        n.o(e, t) ||
            Object.defineProperty(
                e, t, {configurable: !1, enumerable: !0, get: i})
      }, n.r = function(e) {
        ...
        return Object.prototype.hasOwnProperty.call(e, t)
               ...
               [
                 ...
                 function(e, t, n) {
                   ...
                   e.exports = function(e) {
                     'use strict';
                     e = e || {};
                     var t = '', n = i.$each, a = e.audio,
                         r = (e.$value, e.$index, i.$escape), o = e.theme,
                         s = e.index;
                 ...
                 function(e, t, n) {
                   'use strict';
                   Object.defineProperty(t, '__esModule', {value: !0});
                   var i = g(n(33)), a = g(n(32)), r = g(n(31)), o = g(n(30)),
                       s = g(n(29)), l = g(n(28)), u = g(n(27)), c = g(n(26)),
                       p = g(n(25)), d = g(n(24)), h = g(n(23)), y = g(n(22)),
                       f = g(n(21)), v = g(n(20)), m = g(n(19));
                   function g(e) {
                                ...
                                },
                                {
                                  ...
                                  value: function() {
                                    this.player.events.trigger('listshow'),
                                        this.player.template.list.classList
                                            .remove('aplayer-list-hide'),
                                        this.player.template.listOl.scrollTop =
                                            33 * this.index
                                  }
                                },
                                {
                                  ...
                                  value: function(e) {
                                    this.player.events.trigger(
                                        ...
                                        e.map(function(e) {
                                          return e.name = e.name || e.title ||
                                                     'Audio name',
                                                 e.artist = e.artist ||
                                                     e.author || 'Audio artist',
                                                 e.cover = e.cover || e.pic,
                                                 e.type = e.type || 'normal', e
                                        });
                                    ...
                                    this.player.template.listOl.innerHTML +=
                                        ...
                                        this.player.container.classList.add(
                                            'aplayer-withlist'),
                                        this.player.randomOrder =
                                            r.default.randomOrder(
                                                this.audios.length),
                                        ...
                                        this.player.template
                                            .listCurs[this.audios.length - 1]
                                            .style.backgroundColor = e.theme ||
                                        this.player.options.theme,
                                        n &&
                                        ('random' ===
                                                 this.player.options.order ?
                                             this.switch(
                                                 this.player.randomOrder[0]) :
                                             this.switch(0))
                                  }
                                },
                                {
                                  key: 'remove',
                                  value: function(e) {
                                    if (this.player.events.trigger(
                                            'listremove', {index: e}),
                                        this.audios[e])
                                      if (this.audios.length > 1) {
                                        var t = this.player.container
                                                    .querySelectorAll(
                                                        '.aplayer-list li');
                                        t[e].remove(), this.audios.splice(e, 1),
                                            this.player.lrc &&
                                            this.player.lrc.remove(e),
                                            e === this.index &&
                                            (this.audios[e] ?
                                                 this.switch(e) :
                                                 this.switch(e - 1)),
                                ...
                                },
                                {
                                  ...
                                  value: function(e) {
                                    if (this.player.events.trigger(
                                      ...
                                      this.player.template.pic.style
                                          .backgroundImage = t.cover ?
                                          'url(\'' + t.cover + '\')' :
                                          '',
            this.player.theme(
            ...
            this.player.template.author.innerHTML =
                                      ...
                                      n &&
                                          ...
                                          this.player.container
                                              .querySelectorAll(
                                                  '.aplayer-list li')[this.index]
                                              .classList.add(
                                                  'aplayer-list-light'),
                                          (0, o.default)(
                                              33 * this.index, 500, null,
                                          ...
                                          (this.player.template.dtime
                                               .innerHTML =
                                               r.default.secondToTime(
                     ...
                     function e() {
                       !function(e, t) {
                         if (!(e instanceof t))
                           ...
                           this.playerEvents = [
                             'destroy', 'listshow', 'listhide', 'listadd',
                             'listremove', 'listswitch', 'listclear',
                                ...
                                },
                                {
                                  ...
                                  value: function(e, t) {
                                    if (this.events[e] && this.events[e].length)
                                      for (var n = 0; n < this.events[e].length;
                                           n++)
                                        this.events[e][n](t)
                                  }
                                },
                     ...
                     function e(t) {
                       !function(e, t) {
                         if (!(e instanceof t))
                           ...
                           this.player = t, this.initPlayButton(),
                           this.initPlayBar(), this.initOrderButton(),
                           this.initLoopButton(), this.initMenuButton(),
                           a.default.isMobile || this.initVolumeButton(),
                           this.initMiniSwitcher(), this.initSkipButton(),
                           this.initLrcButton()
                     }
                     return i(e,
                              [
                                ...
                                },
                                {
                                  ...
                                  value: function() {
                                    var e = this;
                                    this.player.template.volumeButton
                                    ...
                                    var t = function(t) {
                                      ...
                                      e.player.template.volumeBarWrap.classList
                                          .remove(
                                    ...
                                    this.player.template.order.addEventListener(
                                        'click', function() {
                                          'list' === e.player.options.order ?
                                              (e.player.options.order =
                                                   'random',
                                               e.player.template.order
                                                   .innerHTML =
                                        ...
                                        'click', function() {
                                          e.player.list.audios.length > 1 ?
                                              ...
                                              (e.player.options.loop = 'none',
                                               e.player.template.loop
                                                   .innerHTML =
                                                   r.default.loopNone) :
                                                  'none' ===
                                                      e.player.options.loop ?
                                ...
                                },
                                {
                                  ...
                                  value: function() {
                                    var e = this;
                                    this.player.template.miniSwitcher
                                        .addEventListener('click', function() {
                                          e.player.setMode(
                                              'mini' === e.player.mode ?
                                                  'normal' :
                                ...
                                },
                                {
                                  ...
                                  value: function() {
                                    ...
                                    this.player.template.skipBackButton
                                        ...
                                        this.player.template.skipPlayButton
                                            .addEventListener(
                                                'click', function() {
                                                  e.player.toggle()
                                                })
                                ...
                                },
                                {
                                  ...
                                  value: function() {
                                    var e = this;
                                    this.player.template.lrcButton
                                        .addEventListener('click', function() {
                                          e.player.template.lrcButton.classList
                                                  .contains(
                                                      'aplayer-icon-lrc-inactivity') ?
                                              (e.player.template.lrcButton
                                                   .classList.remove(
                                                       'aplayer-icon-lrc-inactivity'),
                                               e.player.lrc &&
                                                   e.player.lrc.show()) :
                 ...
                 function(e, t, n) {
                   ...
                   e.exports = function(e) {
                     'use strict';
                     e = e || {};
                     var t = '', n = i.$each, a = e.lyrics,
                         r = (e.$value, e.$index, i.$escape);
                     return n(a, function(e, n) {
                              t += '\n    <p',
                                  0 === n &&
                                  (t += ' class="aplayer-lrc-current"'),
                                  t += '>', t += r(e[1]), t += '</p>\n'
                            }), t
                   }
                 },
                     ...
                     function e(t) {
                       !function(e, t) {
                         if (!(e instanceof t))
                           ...
                           this.container = t.container, this.async = t.async,
                           this.player = t.player, this.parsed = [],
                              ...
                              [
                                {
                                  ...
                                  value: function() {
                                    this.player.events.trigger('lrcshow'),
                                        this.player.template.lrcWrap.classList
                                            .remove('aplayer-lrc-hide')
                                  }
                                },
                                {
                                  key: 'hide',
                                ...
                                },
                                {
                                  ...
                                  value: function() {
                                    ...
                                    if (this.index > this.current.length - 1 ||
                                      ...
                                      for (var t = 0; t < this.current.length;
                                           t++)
                                        e >= this.current[t][0] &&
                                            (!this.current[t + 1] ||
                                             e < this.current[t + 1][0]) &&
                                            (this.index = t,
                                             ...
                                             this.container
                                                 .getElementsByClassName(
                                                     'aplayer-lrc-current')[0]
                                                 .classList.remove(
                                                     'aplayer-lrc-current'),
                                             this.container
                                                 .getElementsByTagName('p')[t]
                                                 .classList.add(
                                                     'aplayer-lrc-current'))
                                  }
                                },
                                      ...
                                      for (var t = (e = e.replace(
                                        ...
                                        var r = t[a].match(
                                            ...
                                            o = t[a].replace(
                                                    ...
                                                    .replace(/^\s+|\s+$/g, '');
                                        if (r)
                                          for (var s = r.length, l = 0; l < s;
                                               l++) {
                                            var u = /\[(\d{2}):(\d{2})(\.(\d{2,3}))?]/
                                                        .exec(r[l]),
                                                c = 60 * u[1] + parseInt(u[2]) +
                                                (u[4] ? parseInt(u[4]) /
                                                         (2 ===
                                                                  (u[4] +
                                                                   '').length ?
                       ...
                       !function(e, t) {
                         if (!(e instanceof t))
                           ...
                           this.data = JSON.parse(
                               o.default.storage.get(this.storageName)),
                           this.data || (this.data = {}),
                           this.data.volume =
                     ...
                     function e(t) {
                       !function(e, t) {
                         if (!(e instanceof t))
                           ...
                           this.elements = {}, this.elements.volume = t.volume,
                   ...
                   (function(t) {
                     ...
                     try {
                       e.exports = '[object process]' ===
                           Object.prototype.toString.call(t.process)
                     } catch (e) {
                     }
                   }).call(this, n(4))
                 },
                 function(e, t, n) {
                   'use strict';
                   (function(t) {
                     var i = n(14), a = Object.create(i ? t : window),
                         r = /["&'<>]/;
                     a.$escape = function(e) {
                       return function(e) {
                         var t = '' + e, n = r.exec(t);
                 ...
                 function(e, t, n) {
                   ...
                   e.exports = function(e) {
                     'use strict';
                     var t = '', a = (e = e || {}).options, r = e.cover,
                         o = i.$escape, s = e.icons,
                     ...
                     function e(t) {
                       !function(e, t) {
                         if (!(e instanceof t))
                           ...
                           this.randomOrder = t.randomOrder, this.init()
                     }
                     return i(e, [{
                                key: 'init',
                                value: function() {
                                  ...
                                  this.options.audio.length &&
                                      (e = 'random' === this.options.order ?
                                           this.options
                                               .audio[this.randomOrder[0]]
                                               .cover :
                                           this.options.audio[0].cover),
                                      this.container
                                          .innerHTML = (0, r.default)({
                            ...
                            this.lrcWrap = this.container.querySelector(
                                '.aplayer-lrc'),
                            this.ptime = this.container.querySelector(
                                '.aplayer-ptime'),
                            this.info = this.container.querySelector(
                                '.aplayer-info'),
                            ...
                            this.loaded = this.container.querySelector(
                                '.aplayer-loaded'),
                            this.thumb = this.container.querySelector(
                                '.aplayer-thumb'),
                       ...
                       t.default = function(e) {
                         ...
                         return '[object Array]' !==
                                ...
                                e.audio.map(function(e) {
                                  return e.name =
                                             e.name || e.title || 'Audio name',
                                         e.artist = e.artist || e.author ||
                                             'Audio artist',
                                         e.cover = e.cover || e.pic,
                                         e.type = e.type || 'normal', e
                                }),
                                e.audio.length <= 1 && 'one' === e.loop &&
                                    (e.loop = 'all'),
                                e
                       }
                 },
                 ...
                 function(e, t, n) {
                   ...
                   r.version = '', r.versions = {}, r.on = v, r.addListener = v,
                   r.once = v, r.off = v, r.removeListener = v,
                   r.removeAllListeners = v, r.emit = v, r.prependListener = v,
                   r.prependOnceListener = v, r.listeners = function(e) {
                     return []
                 ...
                 function(e, t, n) {
                   ...
                   (function(e, t) {
                              ...
                              i =
                                  function(e) {
                                    ...
                                    t.onreadystatechange = function() {
                                      y(e), t.onreadystatechange = null,
                                            a.removeChild(t), t = null
                                    }, a.appendChild(t)
                                  }) :
                             i =
                                     function(e) {
                     ...
                     }('undefined' == typeof self ? void 0 === e ? void 0 : e :
                                                    self)
                   }).call(this, n(4), n(34))
                 },
                 function(e, t, n) {
                   ...
                   t.setTimeout =
                       function() {
                     return new a(
                         i.call(setTimeout, window, arguments), clearTimeout)
                   },
                   t.setInterval =
                       function() {
                     return new a(
                         i.call(setInterval, window, arguments), clearInterval)
                   },
                   ...
                   n(35), t.setImmediate = setImmediate,
                 ...
                 function(e, t, n) {
                   ...
                   (function(t) {
                     ...
                     function r(e) {
                       ...
                       this._value = void 0, this._deferreds = [], c(e, this)
                     }
                     function o(e, t) {
                 ...
                 function(e, t, n) {
                   ...
                   var i =
                     ...
                     return function(t, n, i) {
                       ...
                       a = v(n(37)), r = v(n(0)), o = v(n(3)), s = v(n(18)),
                       l = v(n(17)), u = v(n(13)), c = v(n(12)), p = v(n(11)),
                   ...
                   var m = [], g = function() {
                     function e(t) {
                       if (
                           ...
                           this.mode = 'normal',
                           this.randomOrder =
                               r.default.randomOrder(this.options.audio.length),
                           ...
                           this.container = this.options.container,
                           2 === this.options.lrcType ||
                               !0 === this.options.lrcType)
                         for (var n = this.container.getElementsByClassName(
                                      'aplayer-lrc-content'),
                                  i = 0;
                              i < n.length; i++)
                       ...
                       this.template.info.offsetWidth < 200 &&
                           this.template.time.classList.add(
                               'aplayer-time-narrow'),
                       ...
                       this.list = new f.default(this), this.initAudio(),
                       this.bindEvents(),
                                ...
                                [
                                  ...
                                  },
                                  {
                                    ...
                                    value: function() {
                                      var e = arguments.length > 0 &&
                                              void 0 !== arguments[0] ?
                                          arguments[0] :
                                          this.list.audios[this.list.index]
                                                  .theme ||
                                              this.options.theme,
                                      ...
                                      (!(arguments.length > 2 &&
                                       ...
                                       arguments[2]) &&
                                          ...
                                          t === this.list.index &&
                                          (this.template.pic.style
                                               .backgroundColor = e,
                                           this.template.played.style
                                               .background = e,
                                           this.template.thumb.style
                                               .background = e,
                                           this.template.volume.style
                                               .background = e)
                                    }
                                  },
                                  {
                                  ...
                                  },
                                  {
                                    ...
                                    value: function() {
                                      ...
                                      if (this.paused &&
                                              (this.paused = !1,
                                               this.template.button.classList
                                                   .remove('aplayer-play'),
                                               this.template.button.classList
                                                   .add('aplayer-pause'),
                                  ...
                                  },
                                  {
                                    ...
                                    value: function() {
                                      ...
                                      this.paused ||
                                          (this.paused = !0,
                                           this.template.button.classList
                                               .remove('aplayer-pause'),
                                           this.template.button.classList.add(
                                               'aplayer-play'),
                                           this.template.button.innerHTML = '',
                                           setTimeout(
                                               function() {
                                    ...
                                    value:
                                        function() {
                                          ...
                                          if ('random' === this.options.order) {
                                            var e = this.randomOrder.indexOf(
                                                this.list.index);
